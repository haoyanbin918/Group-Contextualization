...
def return_basketball(modality):
    ...
    if modality == 'RGB':
        root_data = '/data1/yanbin/sport_video/frames256/'

        filename_imglist_train = '/data1/yanbin/sport_video/TraValTes/basketball_tsm/train.txt'
        filename_imglist_val   = '/data1/yanbin/sport_video/TraValTes/basketball_tsm/val.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_soccer(modality):
    ...
    if modality == 'RGB':
        root_data = '/data1/yanbin/sport_video/frames256/'
        filename_imglist_train = '/data1/yanbin/sport_video/TraValTes/soccer_tsm/train.txt'
        filename_imglist_val = '/data1/yanbin/sport_video/TraValTes/soccer_tsm/val.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
